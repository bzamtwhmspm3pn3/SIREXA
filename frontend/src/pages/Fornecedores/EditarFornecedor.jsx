      ...
      {usuarioEhTecnico && (
        <div className="bg-blue-600/20 border border-blue-500/30 rounded-xl p-3 mx-4 mb-4">
          <div className="flex items-center gap-2 text-blue-400">
            <Eye size={18} />
            <span className="text-sm">Empresa: <strong>{nomeEmpresaExibicao}</strong></span>
          </div>
        </div>
      )}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              {usuarioEhTecnico ? (
                <div>
                  <div className="w-full p-3 rounded-xl bg-blue-600/20 border border-blue-500/30 text-white flex items-center gap-2">
                    ...
                    <span className="font-medium">{nomeEmpresaExibicao}</span>
                  </div>
                  <input type="hidden" name="empresaId" value={formData.empresaId} />
                  <p className="text-xs text-blue-400 mt-2 flex items-center gap-1">
                    <CheckCircle size={12} className="inline mr-1" /> Você está vinculado a esta empresa como Técnico.
                  </p>
                </div>
              ) : (
                  ...
                  <>
                    <div>
                      ...
                      <select 
                        ...
                        value={formData.fiscal.tipoRetencao} 
                        onChange={(e) => setFormData({...formData, fiscal: {...formData.fiscal, tipoRetencao: e.target.value}})}
                      >
                        <option value="">Selecione</option>
                    ...
                    <div>
                      ...
                      <input 
                        type="number" 
                        className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" 
                        value={formData.fiscal.taxaRetencao} 
                        onChange={(e) => setFormData({...formData, fiscal: {...formData.fiscal, taxaRetencao: parseFloat(e.target.value)}})}
                      />
                    </div>
                  </>
                )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setFormData({...formData, pagamento: {...formData.pagamento, banco: e.target.value}})}
                  />
                </div>
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" 
                    value={formData.pagamento.iban} 
                    onChange={(e) => setFormData({...formData, pagamento: {...formData.pagamento, iban: e.target.value}})}
                  />
                </div>
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => setFormData({...formData, pagamento: {...formData.pagamento, formaPagamento: e.target.value}})}
                  >
            ...
            <div className="flex gap-3 pt-4">
              <button 
                ...
                className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 py-3 rounded-xl transition-all disabled:opacity-50 shadow-lg flex items-center justify-center gap-2"
              >
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 px-6 py-4 border-b border-gray-700 sticky top-0">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-white">{editandoContrato ? "Editar" : "Adicionar"} Contrato</h3>
                </div>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" 
                  placeholder="Ex: Aluguer de Escritório" 
              ...
              <div>
                ...
                <select 
                  className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" 
                  value={novoContrato.modalidadePagamento} 
                  onChange={(e) => setNovoContrato({...novoContrato, modalidadePagamento: e.target.value})}
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setNovoContrato({...novoContrato, diaVencimento: parseInt(e.target.value)})} 
                  />
                </div>
                <div>
                  ...
                  <input 
                    ...
                    max="31" 
                    className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" 
                    value={novoContrato.diaPagamento} 
                    onChange={(e) => setNovoContrato({...novoContrato, diaPagamento: parseInt(e.target.value)})} 
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  onChange={(e) => setNovoContrato({...novoContrato, observacoes: e.target.value})} 
                />
              </div>
            </div>
            <div className="px-6 py-4 border-t border-gray-700 flex justify-end gap-3">
