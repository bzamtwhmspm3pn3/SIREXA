...
const EditarTecnico = () => {
  // 🔥 FILTRO DE MÓDULOS BASEADO NO PLANO DO GESTOR
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="email" className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})} required />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="tel" className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" value={formData.telefone} onChange={(e) => setFormData({...formData, telefone: e.target.value})} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Função</label>
                <input type="text" className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" placeholder="Ex: Técnico de Vendas" value={formData.funcao} onChange={(e) => setFormData({...formData, funcao: e.target.value})} />
              </div>
            </div>
            ...
            <div className="border-t border-gray-700 pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="password" className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" value={novaSenha} onChange={(e) => setNovaSenha(e.target.value)} placeholder="Digite a nova senha" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Confirmar Senha</label>
                  <input type="password" className="w-full p-3 rounded-xl bg-gray-700/50 border border-gray-600 text-white" value={confirmarSenha} onChange={(e) => setConfirmarSenha(e.target.value)} placeholder="Confirme a nova senha" />
                </div>
              </div>
            </div>

            {/* 🔥 Módulos - Seção Operacional (só se gestor tiver) */}
            ...
            {/* 🔥 Módulos - Seção RH (só se gestor tiver) */}
            ...
            {/* 🔥 Módulos - Seção Gestão Patrimonial (só se gestor tiver) */}
            ...
            {/* 🔥 Módulos - Seção Financeiro (só se gestor tiver) */}
            ...
            {/* 🔥 Módulos - Seção Relatórios (só se gestor tiver) */}
            ...
            {/* 🔥 Módulos - Seção CONTABILIDADE (só se gestor tiver) */}
