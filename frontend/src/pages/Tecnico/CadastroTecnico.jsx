...
import { 
  ...
  BookOpen, LayoutDashboard, Lock, RefreshCw  // <-- Adicionar estes ícones
} from "lucide-react";
...
const CadastroTecnico = () => {
  ...
  // Estrutura completa de módulos com CONTABILIDADE
  const [formData, setFormData] = useState({
    ...
    modulos: {
      ...
      // ============================================
      contabilidade: false,      // Acesso geral
  ...
  const [expandedSections, setExpandedSections] = useState({
    ...
    financeiro: false,
    relatorios: false,
    contabilidade: false  // <-- Adicionar esta linha
  });
