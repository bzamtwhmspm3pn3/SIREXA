      ...
      <div className="flex min-h-screen text-white" style={{ background: "linear-gradient(135deg, #003366 0%, #0055A5 50%, #00C0F9 100%)", backgroundAttachment: "fixed" }}>
        <aside className="fixed md:sticky top-0 left-0 z-50 w-72 h-screen flex flex-col transition-transform duration-300 shadow-2xl" style={{ background: "linear-gradient(180deg, #002244 0%, #003366 100%)" }}>
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            <button onClick={() => window.location.href = "/admin"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname === "/admin" ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
              <LayoutDashboard size={18} /><span>Dashboard</span>
            </button>
            <button onClick={() => window.location.href = "/admin/planos"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname === "/admin/planos" ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
              <Award size={18} /><span>Planos</span>
            </button>
            <button onClick={() => window.location.href = "/admin/gerar-chave"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname === "/admin/gerar-chave" ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
              <Key size={18} /><span>Gerar Chave</span>
            </button>
            <button onClick={() => window.location.href = "/admin/licencas"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname === "/admin/licencas" ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
              <FileText size={18} /><span>Licenças</span>
            </button>
            <button onClick={() => window.location.href = "/admin/gestores"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname === "/admin/gestores" ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
              <Users size={18} /><span>Gestores</span>
            </button>
            <button onClick={() => window.location.href = "/admin/empresas"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname === "/admin/empresas" ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
    ...
    <div className="flex min-h-screen text-white" style={{ background: "linear-gradient(135deg, #003366 0%, #0055A5 50%, #00C0F9 100%)", backgroundAttachment: "fixed" }}>
      ...
      {isAuthenticated && !estaNaRotaDeLogin && (
        <aside className={`fixed md:sticky top-0 left-0 z-50 w-72 h-screen flex flex-col transition-transform duration-300 shadow-2xl ${sidebarAberta ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`} style={{ background: "linear-gradient(180deg, #002244 0%, #003366 100%)" }}>
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            <button onClick={() => window.location.href = "/menu"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname === "/menu" || location.pathname === "/" ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
              <Home size={18} /><span>Menu Inicial</span>
            </button>

            <button onClick={() => window.location.href = "/empresa"} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full text-left ${location.pathname.startsWith("/empresa") ? "bg-white/20 text-white font-medium" : "text-gray-300 hover:text-white hover:bg-white/10"}`}>
